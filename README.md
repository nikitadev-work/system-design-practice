...
Размер текста сообщений за день = 55000000 * 35 * 60 * 2 байт = 231 гб/день
За год = 216 * 365 = 85 тб 
За 5 лет = 395 тб без репликации
С 2х факторной репликацией = 800 тб
Рассчет для одной реплики:
Рассматриваем HDD на 6 тб: 400 / 6 = 67 дисков
Шардирование: по 8 дисков на шарде => 9 шардов

Входящий трафик на создание постов:
Количество постов в день: 55000000 * 0.2 = 11.000.000
Если считать что все посты текстовые: 11.000.000 * 500 * 2 = 11000000000 = 11 гб/день

RPS по созданию постов = 11000000 / 24 / 60 / 60 = 128 posts/s
RPS по чтению постов = 55000000 * 120 / 24 / 60 / 60 = 77.000 posts/s
